...
async def procesar_chat(mensaje: MensajeUsuario, request: Request):
    ...
    print("\n" + "=" * 50)
    print(f"📥 1. MENSAJE DEL USUARIO: '{texto}'")
    print(f"📍 2. ESTADO ACTUAL (PASO): '{paso}'")
    print("=" * 50)

    # --- DEFINICIÓN DEL MENÚ PRINCIPAL UNIFICADO ---
    # Usamos texto simple sin emojis numerados para evitar problemas de detección
    ...
    # ==========================================
    # FLUJO 1: SELECCIÓN TIPO DE USUARIO
    # ==========================================
    ...
    # ==========================================
        ...
        cursor.execute("SELECT nombre_completo, pin_seguridad FROM prospectos WHERE correo = %s", (texto,))
        ...
        if texto in ["olvide mi pin", "olvidé mi pin"]:
            ...
            try:
                ...
                if res and pin_ingresado_hash == res["pin_seguridad"]:
                    ...
                    respuesta_texto = "PIN incorrecto. Inténtalo de nuevo o selecciona 'Olvide mi pin'."
                    opciones_lista = ["Olvide mi pin"]
    ...
    # ==========================================
    # FLUJO 4: REGISTRO NUEVO
    # ==========================================
    elif paso == "pidiendo_nombre":
        if texto in ["hola", "inicio", "arrancar", "menú", "menu", ""]:
        ...
        if id_bach:
            ...
            opciones_lista = ["Sistemas", "Mecatrónica", "Industrial", "Bioquímica", "Electromecánica", "Gastronomía"]
        else:
        ...
        if len(texto) == 4 and texto.isdigit():
            ...
            respuesta_texto = "El PIN debe ser de **4 números**. Inténtalo de nuevo."

    # ==========================================
    # FLUJO 5: MENÚ LIBRE (usuario ya autenticado)
    # IMPORTANTE: Los elif más específicos van PRIMERO,
    # los generales (nombre de carrera solo) van AL FINAL.
    # ==========================================
        ...
        if "cerrar sesión" in texto or "cerrar sesion" in texto:
            ...
            estado_conversacion["datos_usuario"] = {}
            respuesta_texto = "Has cerrado sesión correctamente. 🔒||¡Vuelve pronto! Escribe 'Hola' si necesitas algo más."
            opciones_lista = ["Inicio"]

        # ----- OPCIÓN 1: INFORMACIÓN DE CARRERAS -----
        elif texto == "1 - información de carreras" or texto == "información de carreras" or texto == "informacion de carreras":
        ...
        # ----- OPCIÓN 2: PROCESO DE INSCRIPCIÓN -----
        elif texto == "2 - proceso de inscripción" or texto == "proceso de inscripción" or texto == "proceso de inscripcion" or texto == "inscripción" or texto == "inscripcion":
            respuesta_texto = (
        ...
        # ----- OPCIÓN 3: FECHAS DE ADMISIÓN -----
        elif texto == "3 - fechas de admisión" or texto == "fechas de admisión" or texto == "fechas de admision" or "fechas" in texto:
            respuesta_texto = (
        ...
        # ----- OPCIÓN 4: COSTOS -----
        elif texto == "4 - costos" or texto == "costos":
            respuesta_texto = (
        ...
        # ----- OPCIÓN 5: CURSOS DE IDIOMA -----
        elif texto == "5 - cursos de idioma" or texto == "cursos de idioma" or "idioma" in texto or "lengua" in texto:
            respuesta_texto = (
        ...
        # ----- OPCIÓN 6: ACTIVIDADES EXTRAESCOLARES -----
        elif texto == "6 - actividades extraescolares" or texto == "actividades extraescolares" or "extraescolares" in texto:
            respuesta_texto = (
        ...
        # ==========================================================
        # SUBMENÚS DE CARRERAS
        # REGLA: Los elif ESPECÍFICOS van ANTES que el general.
        # Ejemplo: "perfil de ingreso sistemas" ANTES que "sistemas"
        # ==========================================================

        # ===== ELECTROMECÁNICA - SUB-OPCIONES =====
        ...
        # ===== ELECTROMECÁNICA - GENERAL (va después de los específicos) =====
        ...
        elif "áreas de aplicación turismo" in texto or "areas de aplicacion turismo" in texto or "areas de aplicación turismo" in texto:
            respuesta_texto = (
                "🧭 Áreas de aplicación - Turismo||"
        ...
        # ===== SISTEMAS COMPUTACIONALES - SUB-OPCIONES =====
        ...
        elif "áreas de aplicación ciencia de datos" in texto or "areas de aplicacion ciencia de datos" in texto or "areas de aplicación ciencia de datos" in texto:
            respuesta_texto = (
                "🧠 Áreas de aplicación - Ciencia de Datos||"
        ...
        elif texto == "menú principal" or texto == "menu principal":
            ...
            try:
                chat_completion = client.chat.completions.create(
                    messages=[
                        {
                            "role": "system",
                            "content": "Eres ItsaBot, un asistente de admisiones del ITSA. Tienes una personalidad carismática, alegre y servicial. Usa emojis para expresarte. Si no sabes algo, dirige amablemente al WhatsApp 244 120 90 50. Sé breve y amable."
                        },
    ...
    print(f"📤 3. ESTADO NUEVO GUARDADO: '{estado_conversacion['paso_actual']}'")
    print(f"🗣️ 4. TEXTO A RESPONDER: '{respuesta_texto[:50]}...'")
    print("=" * 50 + "\n")

    # ==========================================
    # GENERAR AUDIO Y RESPUESTA FINAL
    # ==========================================
    try:
